	...
	for (;;){
		...
		case ESTADO_JOGO_GAMEPLAY:
			...
			case 1:
				...
				if (tecla.Key == ConsoleKey::S || tecla.Key == ConsoleKey::DownArrow)
				{
					if (escolhaInstrucao == 0){
						ConsoleHelper::ImprimirASCIIExtended(5, 28, ConsoleColor::Blue, ConsoleColor::White, "Virar para Leste - 278");
						ConsoleHelper::ImprimirASCIIExtended(5, 29, "Virar para Oeste - 71");
					}
					else if (escolhaInstrucao == 1){
						ConsoleHelper::ImprimirASCIIExtended(5, 28, "Virar para Leste - 278");
						ConsoleHelper::ImprimirASCIIExtended(5, 29, ConsoleColor::Blue, ConsoleColor::White, "Virar para Oeste - 71");
					}
					escolhaInstrucao++;
					if (escolhaInstrucao == 2)
						escolhaInstrucao = 0;
				}
